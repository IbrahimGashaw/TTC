...
urlpatterns = [
    ...
    path('careers/', RedirectView.as_view(pattern_name='site:vacancy_list', permanent=True)),
    path('careers/<slug:slug>/', views.legacy_vacancy_redirect, name='legacy_vacancy_detail'),
