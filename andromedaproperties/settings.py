"""
Django settings for andromedaproperties project.
"""
...
SECRET_KEY = 'django-insecure-andromeda-properties-development-key-change-in-production'
...
ROOT_URLCONF = 'andromedaproperties.urls'
...
WSGI_APPLICATION = 'andromedaproperties.wsgi.application'
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Andromeda Admin",
    
    # Title on the login screen (19 chars max)
    "site_header": "Andromeda Properties",
    
    # Title on the brand when screen is at < 1200px (19 chars max)
    "site_brand": "Andromeda",
    
    # Logo to use for your site, must be present in static files, used for brand on top left
    # "site_logo": "images/andromeda-logo.svg",
    
    # Logo to use for login form (relative to static files)
    # "login_logo": "images/andromeda-logo.svg",
    ...
    # Relative path to a favicon for your site, will be used in favicon link
    # "site_icon": "images/favicon.ico",
    
    # Welcome text on the login screen
    "welcome_sign": "Welcome to Andromeda Properties Admin",
    
    # Copyright on the footer
    "copyright": "Andromeda Properties",
    
    # The model admin to search from the search bar, search bar omitted if excluded
    "search_model": ["properties.Property", "properties.Project"],
    ...
    "order_with_respect_to": ["properties", "blog", "accounts"],
    ...
    "icons": {
        ...
        "properties.Project": "fas fa-project-diagram",
        "properties.TeamMember": "fas fa-user-tie",
        "properties.Contact": "fas fa-envelope",
        "properties.PropertyBooking": "fas fa-calendar-check",
        "properties.ViewingAppointment": "fas fa-calendar-alt",
        "properties.FloorPlan": "fas fa-drafting-compass",
        "properties.MarketReport": "fas fa-chart-line",
        "properties.BuyingGuide": "fas fa-book",
    ...
    "changeform_format_overrides": {"properties.Property": "collapsible", "auth.user": "collapsible"},
